...
|---|---|---|
| `heading-xl` | 96 px | **144 px** |
| `close-title` | 80 px | **120 px** |
| `heading-lg` | 64 px | **96 px** |
| `stat-number` | 64 px | **96 px** |
| `quote-text` | 52 px | **78 px** |
| `step-num` | 48 px | **72 px** |
| `heading-md` | 40 px | **60 px** |
| `card-title` | 22 px | **33 px** |
| `body` | 20 px | **30 px** |
| `subtitle-mono` | 18 px | **27 px** |
| `list-body` | 16 px | **24 px** |
| `body-card` | 15 px | **22 px** |
| `mono-meta` | 15 px | **22 px** |
| `mono-tag` | 14 px | **21 px** |
| `counter` | 14 px | **21 px** |
| `label` | 13 px | **20 px** |
| `legend-item` | 13 px | **20 px** |
...
⚠️ Even re-anchored, these roles land under 24 px: body-card, mono-meta, mono-tag, counter, label, legend-item. Chrome only — never reading text.
...
BlockFrame is designed as a **1920×1080 presentation system** (effective 1920px × 1080px). Sizing uses CSS `clamp()` for type and fixed px for borders, shadows, and structural padding. The system has three component-level breakpoints for narrow viewports.
