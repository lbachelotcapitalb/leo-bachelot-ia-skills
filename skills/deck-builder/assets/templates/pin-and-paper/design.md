...
|---|---|---|
| `scribble-mega` | 360 px | **360 px** — unchanged |
| `display-mega` | 196 px | **267 px** |
| `display-section` | 168 px | **229 px** |
| `display-stat` | 168 px | **229 px** |
| `h1-cta` | 130 px | **177 px** |
| `h1-chart` | 110 px | **150 px** |
| `h2` | 96 px | **131 px** |
| `h2-md` | 84 px | **115 px** |
| `scribble-lg` | 70 px | **95 px** |
| `scribble-md` | 60 px | **82 px** |
| `h2-sm` | 50 px | **68 px** |
| `quote-text` | 50 px | **68 px** |
| `card-row` | 44 px | **60 px** |
| `card-h3` | 38 px | **52 px** |
| `scribble-sm` | 38 px | **52 px** |
| `scribble-xs` | 32 px | **44 px** |
| `card-h3-sm` | 28 px | **38 px** |
| `body` | 22 px | **30 px** |
| `body-md` | 21 px | **29 px** |
| `body-sm` | 19 px | **26 px** |
| `body-list` | 18 px | **25 px** |
| `label-top` | 18 px | **25 px** |
| `label-meta` | 16 px | **22 px** |
| `stamp` | 16 px | **22 px** |
| `label-footer` | 15 px | **20 px** |
...
⚠️ Even re-anchored, these roles land under 24 px: label-meta, stamp, label-footer. Chrome only — never reading text.
