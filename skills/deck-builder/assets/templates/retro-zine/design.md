...
|---|---|---|
| `display-hero` | 160 px | **300 px** |
| `number-hero` | 160 px | **300 px** |
| `display-cover` | 140 px | **262 px** |
| `display` | 120 px | **225 px** |
| `headline` | 90 px | **169 px** |
| `statement` | 90 px | **169 px** |
| `number-md` | 80 px | **150 px** |
| `drop-cap` | 80 px | **150 px** |
| `headline-md` | 72 px | **135 px** |
| `title` | 42 px | **79 px** |
| `hand-script` | 36 px | **68 px** |
| `hand-script-lg` | 36 px | **68 px** |
| `hand-script-sm` | 22 px | **41 px** |
| `body-md` | 18 px | **34 px** |
| `body` | 16 px | **30 px** |
...
The system targets `1920px × 1080px` and uses `clamp()` throughout for fluid scaling. A single media query at `max-width: 768px` reflows multi-column layouts to single-column, removes inter-column border rules and replaces them with bottom-borders, and reduces slide padding to 32px.
