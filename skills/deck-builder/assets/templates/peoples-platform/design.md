...
This model was authored fluid for a ~1793 px stage; its reading sizes land under the house floor (28 px body). One factor **k = 1.071** re-anchors the ladder on the 1920×1080 canvas, anchored on `body-md` → 30 px. Ratios are preserved, so the model's hierarchy is intact.
...
|---|---|---|
| `display-jumbo` | 540 px | **540 px** — unchanged |
| `quote-mark` | 300 px | **321 px** |
| `display-hero` | 260 px | **278 px** |
| `display-title` | 240 px | **257 px** |
| `display-xl` | 180 px | **193 px** |
| `display-lg` | 140 px | **150 px** |
| `stat-unit` | 130 px | **139 px** |
| `display-md` | 120 px | **129 px** |
| `display-sm` | 108 px | **116 px** |
| `script-lg` | 96 px | **103 px** |
| `kpi-value` | 88 px | **94 px** |
| `quote-body` | 78 px | **84 px** |
| `subtitle` | 72 px | **77 px** |
| `script-md` | 64 px | **69 px** |
| `section-num` | 54 px | **58 px** |
| `card-title` | 54 px | **58 px** |
| `cta` | 48 px | **51 px** |
| `url` | 46 px | **49 px** |
| `item-title` | 38 px | **41 px** |
| `toc-entry` | 36 px | **39 px** |
| `label-accent` | 32 px | **34 px** |
| `item-title-sm` | 30 px | **32 px** |
| `body-lg` | 30 px | **32 px** |
| `stamp` | 28 px | **30 px** |
| `body-md` | 28 px | **30 px** |
| `body-sm` | 26 px | **28 px** |
...
| `body-xs` | 24 px | **26 px** |
| `label` | 24 px | **26 px** |
| `label-wide` | 24 px | **26 px** |

**Multiply the model's spacing, padding, radii, borders and component sizes by the same k = 1.071.** The exceptions are canvas-sized values: `1920px` (was `100vw`), `1080px` (was `100vh`) and anything derived from them stay as written — they are already expressed in canvas units.
