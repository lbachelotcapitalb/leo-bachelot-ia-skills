...
This model was authored fluid for a ~1793 px stage; its reading sizes land under the house floor (28 px body). One factor **k = 1.071** re-anchors the ladder on the 1920×1080 canvas, anchored on `body` → 30 px. Ratios are preserved, so the model's hierarchy is intact.

| role | model (frozen) | **on canvas — use this** |
|---|---|---|
| `section-num` | 320 px | **343 px** |
| `stat-num-lg` | 240 px | **257 px** |
| `stat-num` | 156 px | **167 px** |
| `display` | 132 px | **141 px** |
| `stat-num-sm` | 96 px | **103 px** |
| `title` | 88 px | **94 px** |
| `subtitle` | 56 px | **60 px** |
| `card-headline` | 44 px | **47 px** |
| `card-h3` | 30 px | **32 px** |
| `body` | 28 px | **30 px** |
| `label` | 24 px | **26 px** |
| `pagenum` | 24 px | **26 px** |
| `body-sm` | 22 px | **24 px** |
| `label-sm` | 16 px | **17 px** |
| `label-xs` | 14 px | **15 px** |
...
⚠️ Even re-anchored, these roles land under 24 px: label-sm, label-xs. Chrome only — never reading text.
