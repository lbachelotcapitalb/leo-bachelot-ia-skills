...
This model was authored fluid for a ~1536 px stage; its reading sizes land under the house floor (28 px body). One factor **k = 1.25** re-anchors the ladder on the 1920×1080 canvas, anchored on `body` → 30 px. Ratios are preserved, so the model's hierarchy is intact.
...
|---|---|---|
| `script-section` | 600 px | **600 px** — unchanged |
| `script-huge` | 540 px | **540 px** — unchanged |
| `script-giant` | 360 px | **360 px** — unchanged |
| `script-cover` | 280 px | **350 px** |
| `script-large` | 220 px | **275 px** |
| `script-med` | 156 px | **195 px** |
| `serif-cta` | 140 px | **175 px** |
| `script-sm` | 132 px | **165 px** |
| `serif-h2` | 132 px | **165 px** |
| `serif-stat` | 116 px | **145 px** |
| `serif-quote` | 92 px | **115 px** |
| `serif-chart-h` | 90 px | **112 px** |
| `serif-section-h` | 88 px | **110 px** |
| `serif-toc-num` | 64 px | **80 px** |
| `serif-toc-title` | 56 px | **70 px** |
| `serif-quote-attr` | 48 px | **60 px** |
| `serif-process-h` | 38 px | **48 px** |
| `serif-matrix-label` | 32 px | **40 px** |
| `mono-cover-pre` | 28 px | **35 px** |
| `body` | 24 px | **30 px** |
| `body-toc-desc` | 24 px | **30 px** |
| `mono-runner` | 24 px | **30 px** |
| `body-muted` | 22 px | **28 px** |
| `mono-kicker` | 22 px | **28 px** |
| `mono-label` | 22 px | **28 px** |
| `mono-pill` | 16 px | **20 px** |

**Multiply the model's spacing, padding, radii, borders and component sizes by the same k = 1.25.** The exceptions are canvas-sized values: `1920px` (was `100vw`), `1080px` (was `100vh`) and anything derived from them stay as written — they are already expressed in canvas units.
...
⚠️ Even re-anchored, these roles land under 24 px: mono-pill. Chrome only — never reading text.
