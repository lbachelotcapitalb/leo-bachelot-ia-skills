...
This model is **already authored at the 1920×1080 canvas** — its own sizes are on scale (k = 1). Use them as written.

| role | model (frozen) | **on canvas — use this** |
|---|---|---|
| `display-hero` | 220 px | **220 px** |
| `stat-figure` | 220 px | **220 px** |
| `display` | 140 px | **140 px** |
| `stat-figure-unit` | 110 px | **110 px** |
| `headline-xl` | 96 px | **96 px** |
| `headline` | 84 px | **84 px** |
| `title-card-lg` | 84 px | **84 px** |
| `headline-sm` | 80 px | **80 px** |
| `title-card` | 68 px | **68 px** |
| `title-card-sm` | 56 px | **56 px** |
| `figure-caption-serif` | 56 px | **56 px** |
| `name` | 44 px | **44 px** |
| `meta-value` | 32 px | **32 px** |
| `body-lg` | 32 px | **32 px** |
| `body` | 30 px | **30 px** |
| `body-card` | 26 px | **26 px** |
| `label` | 26 px | **26 px** |
| `label-tight` | 26 px | **26 px** |
| `axis-mono` | 26 px | **26 px** |
| `caption-mono` | 24 px | **24 px** |

**Multiply the model's spacing, padding, radii, borders and component sizes by the same k = 1.0.** The exceptions are canvas-sized values: `1920px` (was `100vw`), `1080px` (was `100vh`) and anything derived from them stay as written — they are already expressed in canvas units.
