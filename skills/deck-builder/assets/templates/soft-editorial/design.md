...
|---|---|---|
| `numeral-hero` | 320 px | **369 px** |
| `display` | 232 px | **268 px** |
| `quote-mark` | 220 px | **254 px** |
| `numeral-lg` | 200 px | **231 px** |
| `title` | 188 px | **217 px** |
| `closer` | 168 px | **194 px** |
| `drop-cap` | 132 px | **152 px** |
| `panel-headline` | 124 px | **143 px** |
| `section-headline` | 96 px | **111 px** |
| `numeral-step` | 92 px | **106 px** |
| `page-headline` | 88 px | **102 px** |
| `quote-text` | 88 px | **102 px** |
| `card-headline` | 72 px | **83 px** |
| `numeral-card` | 64 px | **74 px** |
| `opener` | 56 px | **65 px** |
| `subhead-lg` | 56 px | **65 px** |
| `subhead-md` | 44 px | **51 px** |
| `subhead-sm` | 38 px | **44 px** |
| `kicker` | 38 px | **44 px** |
| `marker` | 32 px | **37 px** |
| `card-sub` | 32 px | **37 px** |
| `eyebrow` | 28 px | **32 px** |
| `page-marker` | 26 px | **30 px** |
| `footer` | 26 px | **30 px** |
| `body` | 26 px | **30 px** |
| `body-md` | 24 px | **28 px** |
| `attr` | 24 px | **28 px** |
| `swatch-label` | 11 px | **13 px** |
...
⚠️ Even re-anchored, these roles land under 24 px: swatch-label. Chrome only — never reading text.
