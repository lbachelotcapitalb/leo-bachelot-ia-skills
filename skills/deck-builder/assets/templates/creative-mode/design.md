...
This model was authored fluid for a ~1536 px stage; its reading sizes land under the house floor (28 px body). One factor **k = 1.25** re-anchors the ladder on the 1920×1080 canvas, anchored on `body-md` → 30 px. Ratios are preserved, so the model's hierarchy is intact.

| role | model (frozen) | **on canvas — use this** |
|---|---|---|
| `display-jumbo` | 220 px | **275 px** |
| `display-hero` | 160 px | **200 px** |
| `display-xl` | 140 px | **175 px** |
| `step-num` | 140 px | **175 px** |
| `display-lg` | 100 px | **125 px** |
| `display-md` | 96 px | **120 px** |
| `stat-num` | 96 px | **120 px** |
| `display-sm` | 84 px | **105 px** |
| `display-xs` | 72 px | **90 px** |
| `stamp-num` | 64 px | **80 px** |
| `marker-label` | 46 px | **58 px** |
| `step-title` | 34 px | **42 px** |
| `badge-label` | 28 px | **35 px** |
| `table-head` | 28 px | **35 px** |
| `table-label` | 28 px | **35 px** |
| `body-lg` | 28 px | **35 px** |
| `body-md` | 24 px | **30 px** |
| `mono-label` | 24 px | **30 px** |
| `mono-kicker` | 24 px | **30 px** |
| `mono-tag` | 24 px | **30 px** |
| `mono-chart` | 24 px | **30 px** |
