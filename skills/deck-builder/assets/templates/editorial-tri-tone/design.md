...
This model was authored fluid for a ~1664 px stage; its reading sizes land under the house floor (28 px body). One factor **k = 1.154** re-anchors the ladder on the 1920×1080 canvas, anchored on `body-md` → 30 px. Ratios are preserved, so the model's hierarchy is intact.
...
|---|---|---|
| `display-stat` | 540 px | **540 px** — unchanged |
| `display-closer` | 320 px | **369 px** |
| `display-wordmark` | 300 px | **346 px** |
| `chapter-num` | 240 px | **277 px** |
| `display-stat-unit` | 220 px | **254 px** |
| `quote-mark` | 200 px | **231 px** |
| `display-xl` | 84 px | **97 px** |
| `display-lg` | 76 px | **88 px** |
| `signature` | 64 px | **74 px** |
| `endorsement-num` | 56 px | **65 px** |
| `timeline-year` | 56 px | **65 px** |
| `lede` | 56 px | **65 px** |
| `quote-heading` | 56 px | **65 px** |
| `subhead-serif` | 48 px | **55 px** |
| `cover-pill` | 44 px | **51 px** |
| `chart-title` | 40 px | **46 px** |
| `card-title` | 40 px | **46 px** |
| `body-lg` | 28 px | **32 px** |
| `body-md` | 26 px | **30 px** |
| `body-sm` | 24 px | **28 px** |
| `label` | 24 px | **28 px** |
| `label-wide` | 24 px | **28 px** |
| `label-mid` | 24 px | **28 px** |
| `label-tight` | 24 px | **28 px** |
| `footer` | 16 px | **18 px** |

**Multiply the model's spacing, padding, radii, borders and component sizes by the same k = 1.154.** The exceptions are canvas-sized values: `1920px` (was `100vw`), `1080px` (was `100vh`) and anything derived from them stay as written — they are already expressed in canvas units.
...
⚠️ Even re-anchored, these roles land under 24 px: footer. Chrome only — never reading text.
