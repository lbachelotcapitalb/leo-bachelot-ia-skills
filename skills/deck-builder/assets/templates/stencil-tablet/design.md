...
This model was authored fluid for a ~1408 px stage; its reading sizes land under the house floor (28 px body). One factor **k = 1.364** re-anchors the ladder on the 1920×1080 canvas, anchored on `body` → 30 px. Ratios are preserved, so the model's hierarchy is intact.
...
|---|---|---|
| `numeral-mega` | 540 px | **540 px** — unchanged |
| `quote-mark` | 320 px | **320 px** — unchanged |
| `numeral-card-xl` | 240 px | **327 px** |
| `cover-hero` | 220 px | **300 px** |
| `numeral-tablet` | 220 px | **300 px** |
| `numeral-stat` | 160 px | **218 px** |
| `section-headline` | 120 px | **164 px** |
| `chart-headline` | 110 px | **150 px** |
| `page-headline` | 92 px | **125 px** |
| `numeral-process` | 64 px | **87 px** |
| `quote-text` | 60 px | **82 px** |
| `date-mark` | 36 px | **49 px** |
| `card-headline` | 34 px | **46 px** |
| `meta-headline` | 32 px | **44 px** |
| `topbar` | 32 px | **44 px** |
| `card-h3` | 30 px | **41 px** |
| `who-name` | 30 px | **41 px** |
| `super` | 28 px | **38 px** |
| `matrix-row` | 26 px | **35 px** |
| `attribution` | 26 px | **35 px** |
| `matrix-head` | 24 px | **33 px** |
| `meta` | 24 px | **33 px** |
| `section-eyebrow` | 24 px | **33 px** |
| `body-lg` | 24 px | **33 px** |
| `footer` | 22 px | **30 px** |
| `process-sub` | 22 px | **30 px** |
| `legend` | 22 px | **30 px** |
| `body` | 22 px | **30 px** |
| `timeline-marker` | 20 px | **27 px** |
| `body-sm` | 20 px | **27 px** |
| `pill` | 18 px | **25 px** |
| `chart-axis` | 18 px | **25 px** |
| `body-xs` | 18 px | **25 px** |

**Multiply the model's spacing, padding, radii, borders and component sizes by the same k = 1.364.** The exceptions are canvas-sized values: `1920px` (was `100vw`), `1080px` (was `100vh`) and anything derived from them stay as written — they are already expressed in canvas units.
