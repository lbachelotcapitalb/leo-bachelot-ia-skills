...
This model was authored fluid for a ~1664 px stage; its reading sizes land under the house floor (28 px body). One factor **k = 1.154** re-anchors the ladder on the 1920×1080 canvas, anchored on `body` → 30 px. Ratios are preserved, so the model's hierarchy is intact.
...
|---|---|---|
| `numeral-jumbo` | 460 px | **460 px** — unchanged |
| `display-section` | 200 px | **231 px** |
| `display-cover` | 184 px | **212 px** |
| `kpi-figure` | 144 px | **166 px** |
| `display` | 130 px | **150 px** |
| `display-md` | 128 px | **148 px** |
| `display-sm` | 120 px | **138 px** |
| `headline-xl` | 104 px | **120 px** |
| `headline` | 92 px | **106 px** |
| `stat-figure` | 92 px | **106 px** |
| `ornament-word-lg` | 84 px | **97 px** |
| `step-numeral` | 80 px | **92 px** |
| `ornament-word` | 76 px | **88 px** |
| `ornament-word-sm` | 68 px | **78 px** |
| `title-card-lg` | 64 px | **74 px** |
| `kpi-figure-unit` | 60 px | **69 px** |
| `title-card` | 48 px | **55 px** |
| `stat-figure-unit` | 48 px | **55 px** |
| `title-card-sm` | 44 px | **51 px** |
| `step-title` | 40 px | **46 px** |
| `eyebrow` | 28 px | **32 px** |
| `body-lg` | 28 px | **32 px** |
| `credit` | 28 px | **32 px** |
| `label` | 26 px | **30 px** |
| `label-tight` | 26 px | **30 px** |
| `body` | 26 px | **30 px** |
| `tag` | 24 px | **28 px** |
| `caption` | 24 px | **28 px** |
| `body-sm` | 24 px | **28 px** |
