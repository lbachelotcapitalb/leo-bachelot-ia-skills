...
> (`~/Documents/Claude/Projects/<repo>-revue-<collab>/registre.md`) : c'est un document
...
| Rapport envoyé | ❌ pas encore — **en attente d'accord explicite de Leo** / ✅ le `<date>` |
...
être bonne) · `reporté` (accepté pour plus tard, avec la raison et l'accord de Leo).
...
visible un bug préexistant sur `main`. Statut à part (`à trancher côté Leo`), et on lui demande
...
| Branche de Leo en attente | Commits | Fichiers en collision | Ce qu'on lui demande |
|---|---|---|---|
...
- <merger / ne pas merger, et le repli si Leo veut la valeur tout de suite>
- Rien n'est poussé, rien n'est mergé, **aucun message ne part sans accord explicite de Leo**.
...
|---|---|---|
| `~/Desktop/revue-<collab>.html` | Leo | décider — captures réelles, glossaire, coût de chaque défaut |
...
| ce fichier | Leo, entre les tours | suivre les statuts |
...
> — il n'a rien de tout ça. Que des chemins de SA branche. **Envoi sur accord explicite de Leo.**
>
